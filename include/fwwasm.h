...
#define FW_GET_EVENT_DATA_MAX 34
	 ...
	 */
	void setBoardLED(int led_index, int red, int green, int blue, int duration_ms, enum LEDManagerLEDMode mode) WASM_IMPORT("setBoardLED");
	...
	void addControlLED(int iPanelIndex,
		...
		int iX,
		int iY,
		enum ePanelColorLED iColor,
		enum ePanelSizeLED iSize,
	...
	void printFloat(const char* szFormatSpec, enum printOutColor iColor, float fDataItem) WASM_IMPORT("printFloat");
